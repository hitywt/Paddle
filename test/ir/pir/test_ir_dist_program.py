...
class TestBuildFakeProgram(unittest.TestCase):
    def test_build_with_shard_tensor(self):
        ...
        dist_input_op = dist_input.get_defining_op()
        self.assertTrue(dist_input_op.has_attr("op_dist_attr"))
        self.assertTrue(dist_input_op.process_mesh == mesh)
        self.assertTrue(dist_input_op.num_operand_dist_attrs() == 0)
        self.assertTrue(dist_input_op.num_result_dist_attrs() == 1)

        dist_w0_op = dist_w0.get_defining_op()
        self.assertTrue(dist_w0_op.has_attr("op_dist_attr"))
        self.assertTrue(dist_w0_op.process_mesh == mesh)
        self.assertTrue(dist_w0_op.num_operand_dist_attrs() == 0)
        self.assertTrue(dist_w0_op.num_result_dist_attrs() == 1)

        dist_w1_op = dist_w1.get_defining_op()
        self.assertTrue(dist_w1_op.has_attr("op_dist_attr"))
        self.assertTrue(dist_w1_op.process_mesh == mesh)
        self.assertTrue(dist_w1_op.num_operand_dist_attrs() == 0)
        self.assertTrue(dist_w1_op.num_result_dist_attrs() == 1)

        # check tensor dist_attr
        self.assertTrue(dist_input_op.result_dist_attr(0).process_mesh == mesh)
        self.assertTrue(
            dist_input_op.result_dist_attr(0).dims_mapping == [-1, -1, -1]
        )

        self.assertTrue(dist_w0_op.result_dist_attr(0).process_mesh == mesh)
        self.assertTrue(dist_w0_op.result_dist_attr(0).dims_mapping == [0, -1])

        self.assertTrue(dist_w1_op.result_dist_attr(0).process_mesh == mesh)
        self.assertTrue(dist_w1_op.result_dist_attr(0).dims_mapping == [-1, 0])
